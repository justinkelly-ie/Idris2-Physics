module Math.DiscreteFeynmanLoop
...
public export
record DiscreteFeynmanLoop where
  constructor MkDiscreteFeynmanLoop
...
public export
discreteRunningCoupling : DiscreteFeynmanLoop -> UnixelFraction
discreteRunningCoupling (MkDiscreteFeynmanLoop alpha0 qSq cutoff) =
...
public export
auditDiscreteFeynmanLoopProof : Bool
auditDiscreteFeynmanLoopProof =
  let loop = MkDiscreteFeynmanLoop (mkUnixelFraction (intToBoxInt 1) 137) (mkUnixelFraction (intToBoxInt 10) 1) 5
